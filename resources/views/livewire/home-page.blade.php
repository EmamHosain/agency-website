<main>
            ...
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-lg-6">
                    <div class="ps-lg-5 text-center">
                        <img loading="lazy" decoding="async" src="{{ asset('frontend/images/about-us.png') }}"
    ...
    <section class="section">
        <div class="container">
            {{-- service wrapper start here --}}
            <div class="row">
                {{-- service item end here --}}
                ...
                $n = $count++;
                @endphp
                <x-home-service-card :service="$service" :n="$n" />
                @endforeach
                @endif

                {{-- service item end here --}}
            </div>
            {{-- service wrapper end here --}}
