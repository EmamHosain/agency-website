        ...
        <div class="container">
            <div class="row">
                <div class="col-8 mx-auto text-center">
                    <h2 class="mb-3 text-capitalize">{{ ucfirst($serviceDetails->title) }}</h2>
                    <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                        ...
                        <li class="list-inline-item">/ &nbsp; <a wire:navigate
                                href="{{ route('serviceDetails',$serviceDetails->id) }}">{{
                                ucfirst( $serviceDetails->title)
                                }}</a>
                        </li>
                    </ul>
                </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-12">
                    <div class="content">
                        ...
                        @if (strlen($serviceDetails->description) > 0)
